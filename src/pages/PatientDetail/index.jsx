      ...
      <div className="patient-detail-page">
        ...
        <div>
          ...
          <div className="button-patient-detail">
            ...
            <button className="edit-button" onClick={editDetailPatient}>
              <MdModeEditOutline
                style={{
                  marginRight: "15px",
                  height: "19px",
        ...
        <div className="medical-diagnose container text-start">
          ...
          <div>
            ...
            <div className="diagnose text-start">
              <span>
                After examination, the results of the medical record showed that
                the patient had symptoms of the disease, namely redness of the
                throat, enlarged salivary glands and mild respiratory distress.
              </span>
            </div>
          </div>
